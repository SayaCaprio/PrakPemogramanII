...
public class FromBiodata extends JFrame {
    ...
    public FromBiodata() {
        ...
        FormBiodataTableModel tableModel = new FormBiodataTableModel();
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (nama.trim().isEmpty() || noTelp.trim().isEmpty() || alamat.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(FromBiodata.this, "Form tidak boleh ada yang kosong!", "Warning",
                            JOptionPane.WARNING_MESSAGE);
                } else {
                    int confirmation = JOptionPane.showConfirmDialog(FromBiodata.this,
                    ...
                    if (confirmation == JOptionPane.YES_OPTION) {
                        ...
                        JOptionPane.showMessageDialog(FromBiodata.this, "Anda tidak memasukan data");
                    }
                }
            }
